...
apiRouter.use("/admin", shiprocketRouter);  // Admin tracking/shiprocket routes under /admin
...
apiRouter.use("/customer", shiprocketRouter);  // Customer tracking routes under /customer
