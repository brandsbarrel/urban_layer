...
const envSchema = z.object({
  ...
  CUSTOMER_JWT_REFRESH_SECRET: z.string().min(32),
  ADMIN_REFRESH_COOKIE_NAME: z.string().min(1).default("admin_refresh_token"),
  CUSTOMER_REFRESH_COOKIE_NAME: z.string().min(1).default("customer_refresh_token"),
